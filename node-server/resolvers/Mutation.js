...
exports.Mutation = {
  ...
  addFieldReview: (parent, { input }, { db }, info) => {
  ...
  deleteFieldReview: (parent, { id }, { db }, info) => {
    db.fieldReviews = db.fieldReviews.filter(
  ...
  updatePart: (parent, { id, input }, { db }, info) => {
  ...
  updateFieldReview: (parent, { id, input }, { db }, info) => {
    const index = db.fieldReviews.findIndex(
      (fieldReview) => fieldReview.id === id
    );
